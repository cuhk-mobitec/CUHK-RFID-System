...
public class SOAPALEServiceClientTestCase extends TestCase {

	public static void main(String[] args) {
		junit.swingui.TestRunner.run(SOAPALEServiceClientTestCase.class);
	}
	...
	public final void testSOAPAle() throws Exception {
		try {
			...
			ECSpec sampleECSpec = getSampleECSpec();
	...
	private ECSpec getSampleECSpec() {
		try {
			JAXBContext jc;
