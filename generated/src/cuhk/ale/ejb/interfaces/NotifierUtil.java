...
public class NotifierUtil
{
  ...
  private static final java.lang.String DESTINATION_JNDI_NAME="queue/NotifierQueue";
  private static final java.lang.String CONNECTION_FACTORY_JNDI_NAME="ConnectionFactory";
    ...
    * @return Destination JMS Queue for Notifier. Lookup using JNDI_NAME
    */
   ...
   /**
    * Obtain destination queue from default initial context
    * @return Destination JMS Connection Factory for Notifier. Lookup using JNDI_NAME
    */
   ...
   public static final String generateGUID(Object o) {
       ...
       if (hexServerIP == null) {
           ...
           try {
               ...
               System.err.println("NotifierUtil: Could not get the local IP address using InetAddress.getLocalHost()!");
