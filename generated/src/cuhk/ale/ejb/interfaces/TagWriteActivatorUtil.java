...
/**
 * Utility class for TagWriteActivator.
 * @xdoclet-generated at ${TODAY}
 * @copyright The XDoclet Team
 * @author XDoclet
 * @version ${version}
 */
public class TagWriteActivatorUtil
{
  ...
  private static final java.lang.String DESTINATION_JNDI_NAME="queue/TagWriteActivatorQueue";
  private static final java.lang.String CONNECTION_FACTORY_JNDI_NAME="ConnectionFactory";
    ...
    * @return Destination JMS Queue for TagWriteActivator. Lookup using JNDI_NAME
    */
   ...
   /**
    * Obtain destination queue from default initial context
    * @return Destination JMS Connection Factory for TagWriteActivator. Lookup using JNDI_NAME
    */
   ...
   public static final String generateGUID(Object o) {
       ...
       if (hexServerIP == null) {
           ...
           try {
               ...
               System.err.println("TagWriteActivatorUtil: Could not get the local IP address using InetAddress.getLocalHost()!");
